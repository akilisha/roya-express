...
public interface WorkflowVisitor {
    ...
    /**
     * Called when a continuation workflow is starting
     */
    default void onContinuationStart(String nodeId, String childWorkflowId) {}
    
    /**
     * Called when a continuation workflow completes
     */
    default void onContinuationComplete(String nodeId, String childWorkflowId, boolean success) {}
    
    /**
     * Called when nested workflows are starting
     */
    default void onNestedWorkflowsStart(String nodeId, int childCount) {}
    
    /**
     * Called when a child workflow completes in nested execution
     */
    default void onChildWorkflowComplete(String parentNodeId, int childIndex, boolean success) {}
    
    /**
     * Called when all nested workflows complete
     */
    default void onNestedWorkflowsComplete(String nodeId, int successCount, int failureCount) {}
}
