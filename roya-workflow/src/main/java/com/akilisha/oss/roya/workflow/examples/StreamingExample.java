...
//                                subscriber.onNext(new StreamChunk(sentence + " ", false, Map.of()));
//                                try { Thread.sleep(200); } catch (InterruptedException e) { break; }
//                            }
//
//                            subscriber.onNext(new StreamChunk("", true, Map.of()));
//                            subscriber.onComplete();
//                        }).start();
//                    }
//
...
//                                System.out.print(c);
//                                subscriber.onNext(new StreamChunk(String.valueOf(c), false, Map.of()));
