package com.akilisha.oss.roya.plugins.mcp;
    ...
    public static void main(String[] args) {
        ...
        app.post("/mcp/tools/docs.searchAndSummarize", (Request req, Response res, Next next) -> {
            try {
                ...
                // Build citations from returned sources (metadata may contain source/chunkIndex)
        ...
        app.listen(port, () -> System.out.println("roya-mcp (Docs) running on http://localhost:" + port));
    }
