  ...
  return (
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="mb-8">
        ...
        <h1 class="text-4xl md:text-5xl font-bold mb-4 text-roya-text dark:text-roya-textDark tracking-tight font-sans">Plugins</h1>
      ...
      <div class="space-y-8">
        <section class="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-8 border-2 border-purple-200">
          <h2 class="text-2xl font-bold mb-4 text-roya-text dark:text-roya-textDark font-sans">What are Plugins?</h2>
        ...
        <section class="bg-white rounded-lg shadow-md p-8">
          <h2 class="text-2xl font-bold mb-4 text-roya-text dark:text-roya-textDark font-sans">Using Plugins</h2>
          <p class="text-gray-700 mb-4">
...
Database db = app.services().get(Database.class);</code></pre>
        ...
        <section class="bg-white rounded-lg shadow-md p-8">
          <h2 class="text-2xl font-bold mb-4 text-roya-text dark:text-roya-textDark font-sans">Built-in Plugins</h2>
          
          <h3 class="text-xl font-bold mt-6 mb-3 text-roya-text dark:text-roya-textDark font-sans">AI Plugin</h3>
          <p class="text-gray-700 mb-4">
...
String response = ai.llm().ask("...", "...");</code></pre>
          ...
          <h3 class="text-xl font-bold mt-6 mb-3 text-roya-text dark:text-roya-textDark font-sans">Database Plugin</h3>
          <p class="text-gray-700 mb-4">
...
List&lt;User&gt; users = db.query("SELECT * FROM users")
    .list(User.class);</code></pre>
          ...
          <h3 class="text-xl font-bold mt-6 mb-3 text-roya-text dark:text-roya-textDark font-sans">Email Plugin</h3>
          <p class="text-gray-700 mb-4">
...
email.send("to@example.com", "Subject", "Body");</code></pre>
        ...
        <section class="bg-white rounded-lg shadow-md p-8">
          <h2 class="text-2xl font-bold mb-4 text-roya-text dark:text-roya-textDark font-sans">Creating Custom Plugins</h2>
          <p class="text-gray-700 mb-4">
...
MyService service = app.services().get(MyService.class);`}</code></pre>
        ...
        <section class="bg-white rounded-lg shadow-md p-8">
          <h2 class="text-2xl font-bold mb-4 text-roya-text dark:text-roya-textDark font-sans">Plugin Lifecycle</h2>
          <p class="text-gray-700 mb-4">
        ...
        <section class="bg-purple-50 border border-purple-200 rounded-lg p-6">
          <h3 class="text-lg font-bold text-roya-primary dark:text-roya-primary mb-2 font-sans">💡 Batteries Included</h3>
