...
public class JExpressRouter implements Router, Routable {
    ...
    public JExpressRouter(RouterOptions options, RootRoutable rootRoutable, ContextRoutable contextRoutable) {
    ...
    public Router route(String path) {
        Router router = new JExpressRouter(new BaseRouterOptions(true, true, true), new RootRoutable(), contextRoutable);
